...
import panelLogo from "../assets/LOGO.svg";
...
export const StaggeredMenu = ({
  ...
  return (
    ...
    >
      {/* colored pre-layers behind the panel */}
      ...
      <header className="staggered-menu-header">
        <div
          className={`sm-header-shell ${
            hasScrolled ? "sm-header-shell--glass" : ""
          }`}
        >
      ...
      >
        <div className="sm-panel-inner">
          {/* TOP ROW: logo left, close right – shared for mobile/tablet/desktop */}
          <div className="sm-panel-top">
            ...
            >
              Close <span className="sm-panel-close-icon">×</span>
            </button>
          </div>
